...
export const FARE_TYPES: Record<string, { label: string; color: string; bgColor: string }> = {
  ...
  WAVE: { label: "Ofertă Wave", color: "#0C447C", bgColor: "#E6F1FB" },
  WAVEPREM: { label: "Ofertă Wave Premium", color: "#412402", bgColor: "#FAEEDA" },
  WAVESOFT: { label: "Ofertă Wave Soft", color: "#085041", bgColor: "#E1F5EE" },
